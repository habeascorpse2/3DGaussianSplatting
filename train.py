...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    first_iter += 1
    # Cada iteração passa por esse loop, e começa pela iteração 1
        ...
        with torch.no_grad():
            ...
            if iteration < 15000:
                ...
                if iteration > opt.densify_from_iter and iteration % opt.densification_interval == 0:
                    ...
                    gaussians.densify_and_prune(opt.densify_grad_threshold, 0.02, scene.cameras_extent, size_threshold)
